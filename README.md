...
This branch solely exists to hold all the patches used in some form or another in jdwm. Many have been modified, changed, or otherwise altered from their original state. 
That being said, the original code was never my own, so I wish to give credit where credit is due.
